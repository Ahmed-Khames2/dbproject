...
class _OrderDetailsPageState extends State<OrderDetailsPage> {
  ...
  void _saveStatus() {
    final index = dummyOrders.indexWhere((o) => o.orderId == widget.order.orderId);
    if (index != -1) {
        ...
        child: Column(
          ...
          children: [
            ...
            Card(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Order ID: ${widget.order.orderId}', style: Theme.of(context).textTheme.titleLarge),
                    const SizedBox(height: 8),
                    Text('User: ${getUserName(widget.order.userId)}'),
                    Text('Date: ${widget.order.orderDate.toString().substring(0, 10)}'),
            ...
            DropdownButtonFormField<String>(
              ...
              items: ['Pending', 'Shipped', 'Delivered', 'Cancelled'].map((status) {
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final product = dummyProducts.firstWhere(
                  ...
                  orElse: () => ProductModel(
                    productId: 0, categoryId: 0, name: 'Unknown Product',
                    price: 0, stock: 0),
                );
                return ListTile(
